...
export const Pagination = ({pagination, fetchNextPage, fetchPreviousPage}) => {
    ...
    const disabledButton = !previousPage
    const disabledNextButton = currentPage === pagination?.pages
    ...
    return (
        <Container>
            <button onClick={handlePreviousPage} disabled={disabledButton} >&lt;</button>
            <div className="container-page">
                <p className="page">{previousPage}</p>
                <p className="current-page">{currentPage}</p>
                <p className="page">{nextPage}</p>
            </div>
            <button onClick={handleNextPage} disabled={disabledNextButton}>&gt;</button>
        </Container>
    )
}